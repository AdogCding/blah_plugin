...
// 2. 定义存储文件的名称
@State(name = "org.gcb.blah.mybatis.jump.PluginSettingState", storages = [Storage("MyBatisPluginSettings.xml")])
class PluginSettingState: PersistentStateComponent<PluginSettingState> {
    ...
    override fun loadState(state: PluginSettingState) {
        ...
        this.mybatisAnnotationMapperName = state.mybatisAnnotationMapperName
    }
